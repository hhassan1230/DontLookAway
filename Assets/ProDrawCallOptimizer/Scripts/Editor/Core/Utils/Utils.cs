...
namespace ProDrawCall {
	...
	public static class Utils {
        ...
        public static string GetCurrentSceneName() {
            string[] sceneSeparatedPath = EditorApplication.currentScene.Split(char.Parse("/"));
            return sceneSeparatedPath[sceneSeparatedPath.Length-1];
        }

        public static void GeneratePrefab(GameObject obj, string pathToPrefab, string name, bool hasSkinnedMeshRenderer) {
